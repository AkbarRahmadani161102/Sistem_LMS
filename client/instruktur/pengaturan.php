                ...
                <div class="bg-gray-100 dark:bg-gray-800 rounded shadow-lg px-5 py-4 flex flex-col justify-between">
                    ...
                    <form class="w-full" action="../../api/user/user_settings.php" method="post">
                        <div class="mb-5">
                            ...
                            <input type="text" class="border rounded w-full py-1.5 border-gray-400 mt-1" id="nama" name="nama" value="<?= $data_instruktur['nama'] ?>" maxlength="50" required>
                        </div>
                        <div class="mb-5">
                            <label for="no_telp" class="form-label text-secondary text-gray-400">Nomor Telepon</label>
                            <input type="text" class="border rounded w-full py-1.5 border-gray-400 mt-1" id="no_telp" name="no_telp" value="<?= $data_instruktur['no_telp'] ?>" maxlength="14" required>
                        </div>
                        <div class="mb-5">
                            <label for="alamat" class="form-label text-secondary text-gray-400">Alamat</label>
                            <textarea class="border rounded w-full py-1.5 border-gray-400 mt-1 resize-none" id="alamat" name="alamat" required maxlength="40"><?= $data_instruktur['alamat'] ?></textarea>
                        </div>
                ...
                <div class="bg-gray-100 dark:bg-gray-800 rounded shadow-lg px-5 py-4 flex flex-col justify-between">
                    ...
                    <form class="w-full" action="../../api/user/user_settings.php" method="post">
                        <div class="mb-5">
                            ...
                            <input type="email" class="border rounded w-full py-1.5 border-gray-400 mt-1" id="email" name="email" value="<?= $data_instruktur['email'] ?>" maxlength="30" required>
                        </div>
                        <div class="mb-5">
