...
$sql = "SELECT * FROM instruktur WHERE id_instruktur = '$id_instruktur' LIMIT 1";
$data_instruktur = $db->query($sql)->fetch_assoc();

$nama = $data_instruktur['nama'];
$no_telp = $data_instruktur['no_telp'];
$alamat = $data_instruktur['alamat'];
        ...
        <div class="w-full px-10">
            ...
            <div class="flex flex-col mb-5 mt-7 gap-10">
                <div class="bg-gray-100 rounded shadow-lg px-5 py-4">
                    ...
                    <form class="w-full" action="../../api/user/user_settings.php" method="post">
                        <div class="mb-5">
                            ...
                            <input type="text" class="border rounded w-full py-1.5 border-gray-400 mt-1" id="nama" name="nama" value="<?= $nama ?>" required>
                        </div>
                        <div class="mb-5">
                            <label for="no_telp" class="form-label text-secondary text-gray-400">Nomor Telepon</label>
                            <input type="text" class="border rounded w-full py-1.5 border-gray-400 mt-1" id="no_telp" name="no_telp" value="<?= $no_telp ?>" required>
                        </div>
                        <div class="mb-5">
                            <label for="alamat" class="form-label text-secondary text-gray-400">Alamat</label>
                            <textarea class="border rounded w-full py-1.5 border-gray-400 mt-1" id="alamat" name="alamat" required><?= $alamat ?></textarea>
                        </div>
                ...
                <div class="bg-gray-100 rounded shadow-lg px-5 py-4">
                    ...
                    <form class="w-full" action="../../api/instruktur/instruktur.php" method="post">
                        <div class="mb-5">
                            <label for="email" class="form-label text-secondary text-gray-400">Email</label>
                            <input type="email" class="border rounded w-full py-1.5 border-gray-400 mt-1" id="email" name="email" value="<?= $email ?>" required>
                        </div>
                        <div class="mb-5">
