...
<div class="w-screen h-screen">
    <div class="flex justify-items-center items-center">
        <div class="w-full h-screen bg-login-instruktur bg-cover bg-center bg-no-repeat">
        </div>
        <div class="w-full flex-col justify-items-center">
            <h3 class="text-center">Login sebagai instruktur</h3>
            ...
            <p class="text-center">Untuk mendaftar silahkan ajukan pendaftaran <span class="text-amber-500">onsite</span></p>
        </div>
    </div>
</div>
