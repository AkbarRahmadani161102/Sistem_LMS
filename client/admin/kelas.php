...
$sql = "SELECT k.*, j.nama jenjang, s.nama ketua_kelas FROM kelas k, jenjang j, siswa s WHERE k.id_jenjang = j.id_jenjang AND k.id_ketua_kelas = s.id_siswa";
    ...
    <div class="w-full flex flex-col">
        <div class="p-4 sm:ml-64">
            ...
            <div class="flex items-center gap-5">
                <h4 class="my-7 font-semibold text-gray-800 dark:text-white">kelas</h4>
                        ...
                        <?php foreach ($result as $key => $value) : ?>
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 flex gap-4">
                                    <button type="button" class="px-5 py-2 border border-blue-500 rounded group hover:bg-blue-500" data-modal-target="edit<?= $value['id_kelas'] ?>" data-modal-toggle="edit<?= $value['id_kelas'] ?>">
                            ...
                            <div id="edit<?= $value['id_kelas'] ?>" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <form action="../../api/admin/kelas.php" method="post">
                                            ...
                                            <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                                                <button data-modal-hide="defaultModal" type="submit" name="update" value="<?= $value['id_kelas']?>" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Ubah</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
