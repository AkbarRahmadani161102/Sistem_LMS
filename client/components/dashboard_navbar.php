...
<div class="max-w-full flex text-gray-800 dark:text-white">
    <div class="w-full flex items-center justify-between h-fit gap-3">
        ...
        <label class="hidden lg:flex px-5 bg-white dark:bg-slate-700 lg:mr-auto rounded-full w-3/6 flex items-center">
        ...
        <button data-dropdown-toggle="settings_dropdown" type="button"><i class="ri-arrow-down-s-line text-2xl hover:text-amber-500"></i></button>
