...
<div class="w-screen h-screen">
    <div class="flex justify-items-center items-center">
        <div class="w-full h-screen bg-login-siswa bg-cover bg-center bg-no-repeat">
        </div>
        <div class="w-full flex-col justify-items-center">
            ...
            <p class="text-center">Belum memiliki akun? <a class="text-orange-500" href="./register.php">Klik Disini</a></p>
        </div>
    </div>
</div>
