...
<div class="w-screen h-screen">
    <div class="flex justify-items-center items-center">
        <div class="w-full h-screen bg-register-siswa bg-cover bg-center bg-no-repeat flex justify-center items-center">
            <div class="max-w-lg">
        ...
        <div class="w-full flex-col justify-items-center">
            <h3 class="text-center">Daftar sebagai siswa</h3>
            <form class="max-w-md mx-auto my-5" action="../../api/auth/auth.php" method="post">
                <div class="mb-5">
                    <label for="nama_lengkap" class="form-label text-secondary text-gray-400">Nama Lengkap</label>
                    <input type="text" class="border rounded w-full py-1.5 border-gray-400 mt-1" id="nama_lengkap" name="nama" required>
                </div>
                <div class="mb-5">
                    <label for="email" class="form-label text-secondary text-gray-400">Email address</label>
            ...
            <p class="text-center">Sudah memiliki akun? <a class="text-orange-500" href="./login.php">Klik Disini</a></p>
        </div>
    </div>
</div>
