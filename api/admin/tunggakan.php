...
if (isset($_POST['sync'])) {
    ...
    $sql = "SELECT s.id_siswa, j.nama nama_jenjang, k.nama nama_kelas, j.biaya_pendidikan FROM siswa s
    ...
    foreach ($data_siswa as $siswa) {
        ...
        $deskripsi = "Tunggakan kelas $nama_kelas";
        $sql = "INSERT INTO tunggakan (id_siswa, tenggat_pembayaran, deskripsi, nominal, tgl_dibuat)
        VALUES('$id_siswa', '$tenggat', '$deskripsi', '$biaya_pendidikan', '$tanggal_trigger')";
        $db->query($sql);
